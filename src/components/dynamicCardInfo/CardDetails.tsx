...
const CardDetails = ({detail}:any) => {
  console.log(detail)
  return (
    <div className="flex xl:flex-row flex-col items-center  bg-white shadow-lg shadow-[#1018281A] rounded-lg p-4 mb-6 w-full max-w-[960px] ">
      <div className="flex xl:flex-row flex-col gap-3 xl:gap-0 items-center xl:w-4/5">
        <Image
          height={200}
          width={250}
          src="/card/snow.jpg"
          alt="Snow Forest"
          className="w-full xl:w-0 rounded-xl"
        />
      ...
      <div className="p-6  h-full xl:w-1/5">
